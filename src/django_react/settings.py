...
ALLOWED_HOSTS = json.loads(os.environ['HOST_LIST'])
...
STATIC_ROOT = os.path.abspath(os.path.join(
    BASE_DIR, '/django_react', 'static'))
STATIC_URL = '/static/'

MEDIA_ROOT = os.path.abspath(os.path.join(
    BASE_DIR, '/django_react', 'media'))
MEDIA_URL = '/media/'
...
CORS_ORIGIN_WHITELIST = json.loads(os.environ["CORS_WHITE_LIST"])
